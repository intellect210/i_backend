// FILE: config/config-constants.txt
const MESSAGE_TYPES = {
  TEXT: 'text',
  CHUNK: 'chunk',
  CHUNK_END: 'chunk_end',
...
const ERROR_CODES = {
  ...
  NOTIFICATION_ERROR: 'NOTIFICATION_ERROR',
   FCM_INITIALIZATION_ERROR: 'FCM_INITIALIZATION_ERROR',
    FCM_NOTIFICATION_CONSTRUCTION_ERROR: 'FCM_NOTIFICATION_CONSTRUCTION_ERROR',
    FCM_TOKEN_NOT_FOUND: 'FCM_TOKEN_NOT_FOUND',
    BULL_QUEUE_ERROR: 'BULL_QUEUE_ERROR',
};
